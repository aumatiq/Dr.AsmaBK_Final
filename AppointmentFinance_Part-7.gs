...
// ─────────────────────────────────────────────
// Part 7 — Gap ৪ অডিট ফলাফল: এই সেকশনের addFinanceEntry(),
// getFinanceEntries(), getMonthlyFinanceSummary() — তিনটাই আগে থেকেই
// requireDoctor(token) দিয়ে গার্ড করা ছিল (Receptionist কোনোভাবেই
// Finance ডেটা পড়তে/লিখতে পারে না)। DashboardAdapter.gs-এর
// getSettingsData() ও saveDoctorProfile()-ও requireDoctor() দিয়ে
// গার্ড করা — কোনো ফিক্স লাগেনি, শুধু ডাবল-চেক করে নিশ্চিত করা হলো।
// ═══════════════════════════════════════════════

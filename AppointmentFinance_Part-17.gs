...
function bookAppointment(bookingData) {
  ...
  // ── v3.3 (Part 17 — Security Hardening): পাবলিক বুকিং ফর্ম থেকে আসা reason
  //    ফিল্ড sanitize করা হচ্ছে (এটাই stored XSS-এর সবচেয়ে বড় ঝুঁকির জায়গা ছিল,
  //    কারণ এই ডেটা পরে Doctor Dashboard-এ login-করা ব্যবহারকারীর সামনে দেখানো হয়) ──
  apptSheet.appendRow([
    newApptId,
    patientId,
    new Date(bookingData.date),
    bookingData.timeSlot,
    sanitizeUserText_(bookingData.reason),
    "Pending",
    new Date(),
  ]);
